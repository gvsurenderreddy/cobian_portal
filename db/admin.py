...
class UserChoiceField(forms.ModelChoiceField):
     def label_from_instance(self, obj):
         return "%s - %s %s" % (obj.username, obj.first_name, obj.last_name)
         
class AccountRepChoiceField(forms.ModelChoiceField):
     def label_from_instance(self, obj):
         return "%s - %s %s" % (obj.account_id, obj.user.first_name, obj.user.last_name)
...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = UserProfile
        exclude = []
        #fields = ["account_id","company","phone","terms","notes","locked","terms_accepted","terms_uploaded","eula_accepted"]
...
class MediaFileAdmin(admin.ModelAdmin):
    list_display = ("thumbnail", "title", "file_name", "tags", "file_type",)
    list_filter = ("file_type", "file_extension", "tags")
    ordering = ("title",)
    search_fields = ("title", "file_path", "tags")
    fields = ("title", "file_type", "file_path", "description", "tags",)
    formfield_overrides = {
...
class UserProfileAdmin(admin.ModelAdmin):
    ...
    list_filter = ("user_type", "terms_uploaded", "terms_accepted")
